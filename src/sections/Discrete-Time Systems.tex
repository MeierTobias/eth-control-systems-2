...
\end{align*}
which means that all Eigenvalues must lie within the unit circle.\\
...
Reminder:
\noindent\begin{align*}
    \left.\exp\left(\begin{bmatrix}\lambda&1\\ 0&\lambda\\\end{bmatrix}\right.t\right) &=\begin{bmatrix}1&t\\0&1\\0&0\end{bmatrix}\text{e}^{\lambda t} \\
