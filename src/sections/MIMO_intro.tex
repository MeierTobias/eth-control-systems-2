...
\begin{examplesection}[Example (From Script of Gioele Zardini)]
    ...
    \end{align*}
    2. Find $d_{\min}(s)$ (multiple of denominators):
    \begin{equation*}
...
Invariant zeros are the values of $s$ for which the following matrix becomes singular and therefore the determinant of the matrix is zero:
\begin{equation*}
