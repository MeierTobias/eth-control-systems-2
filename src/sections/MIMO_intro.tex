...
\begin{enumerate}
    ...
    \item Evaluate singular values:
          \begin{enumerate}
              \item The input direction $\mathbf{u_i}$ with correspoding $\sigma_i=0$ is the \textbf{direction of the zero}.
              \item The input direction $\mathbf{u_i}$ of the largest $\sigma_i$ is the \textbf{direction of the pole}.
          \end{enumerate}
\end{enumerate}
