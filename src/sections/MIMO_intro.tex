...
\textbf{Remarks}:
\begin{itemize}
    \item In words, the maximum amplification of the absolute values in time domain corresponds to the maximum singular value of the system.   % TODO: Correct?
...
\noindent\begin{equation*}
    \|\mathbf{G}\|_{\mathcal{H}_\infty} = \sup_{\omega}\sigma_{\max}\bigl(\mathbf{G}(j\omega)\bigr)
\end{equation*}
