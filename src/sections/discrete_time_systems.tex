...
\includegraphics[width=0.4\linewidth]{disc_approx_forward.pdf}
...
\includegraphics[width=0.4\linewidth]{disc_approx_backwards.pdf}
...
\includegraphics[width=0.4\linewidth]{disc_approx_trapezoid.pdf}
