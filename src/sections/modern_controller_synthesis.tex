...
% TODO: Would one then make S large to achieve a small C?
...
% TODO: Some more remarks on why we need F(s) and how we use the things derived in this section to actually create a controller.
