...
Controllability is a \textbf{necessary and sufficient condition} for arbitrary pole placement. If the system is
uncontrollable and diagonalizable, the uncontrollable poles can't be moved.

\subsubsection{Ackermann's Formula}
Assuming that the system is \textbf{controllable}, Ackermann's formula can be used to calculate $\mathbf{K}$ for both \textbf{CT} and \textbf{DT} systems:
\noindent\begin{align*}
