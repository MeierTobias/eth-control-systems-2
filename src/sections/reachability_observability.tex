...
% TODO: Is it right that these two conditions are just a "weaker" subset of Reachability/Observability? -> NO, they are super sets (a reachable system is always stabilizable but an unreachable system can be stabilazable if the unreachable modes are stable.)
